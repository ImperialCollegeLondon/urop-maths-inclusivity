...
#################### MAIN ####################################################
class NewIntegrationOrder2(MyThreeDScene):
...
#Initial integration steps
        ...
        dz_coord_end = axes.c2p(0.5,0.6,0.15)
        dz = Line(dz_coord_start,dz_coord_end,color=YELLOW,stroke_width=2.5)

        start_point = axes.c2p(0.5,0.25,0.15)
        end_point = axes.c2p(0.5,1,0.15)
